...
namespace ZzzWF {
    ...
    public partial class ZzzDataSet : global::System.Data.DataSet {
        ...
        public partial class CUSTOMERSDataTable : global::System.Data.TypedTableBase<CUSTOMERSRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CUSTOMERSRow AddCUSTOMERSRow(string Name, string City, string Phone) {
...
namespace ZzzWF.ZzzDataSetTableAdapters {
    ...
    public partial class CUSTOMERSTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[CUSTOMERS] WHERE (([Id] = @Original_Id) AND ([Name] = @Origina" +
                "l_Name) AND ([City] = @Original_City) AND ([Phone] = @Original_Phone))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[CUSTOMERS] ([Name], [City], [Phone]) VALUES (@Name, @City, @Ph" +
                "one);\r\nSELECT Id, Name, City, Phone FROM CUSTOMERS WHERE (Id = SCOPE_IDENTITY())" +
                "";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[CUSTOMERS] SET [Name] = @Name, [City] = @City, [Phone] = @Phone WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([City] = @Original_City) AND ([Phone] = @Original_Phone));
SELECT Id, Name, City, Phone FROM CUSTOMERS WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ZzzWF.Properties.Settings.Default.ZzzConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, City, Phone FROM dbo.CUSTOMERS";
        ...
        public virtual int Fill(ZzzDataSet.CUSTOMERSDataTable dataTable) {
        ...
        public virtual ZzzDataSet.CUSTOMERSDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ZzzDataSet.CUSTOMERSDataTable dataTable = new ZzzDataSet.CUSTOMERSDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ZzzDataSet.CUSTOMERSDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_City, string Original_Phone) {
        ...
        public virtual int Insert(string Name, string City, string Phone) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string City, string Phone, int Original_Id, string Original_Name, string Original_City, string Original_Phone, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string City, string Phone, int Original_Id, string Original_Name, string Original_City, string Original_Phone) {
            return this.Update(Name, City, Phone, Original_Id, Original_Name, Original_City, Original_Phone, Original_Id);
        }
    }
